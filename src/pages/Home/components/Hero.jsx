...
const Hero = () => {
    return (
        <div className='relative w-full'>
            <img src={HeroImg} alt="img" className='w-full h-[880px] lg:max-h-screen object-cover'/>
            <div className='absolute inset-0  pt-[30%] md:pt-[15%] space-y-20 lg:space-y-36 bg-cover' style={{ background:'linear-gradient(90deg, rgba(0, 0, 0, 0.93) 0%, rgba(0, 0, 0, 0.22) 48.58%, rgba(0, 0, 0, 0.00) 100%)'}}>
                ...
                {/* <div className='grid justify-items-center gap-4'>
                    <img src={HeroIcon} alt="img" />
                    <p className='text-lg bg-gradient text-transparent bg-clip-text uppercase font-semibold tracking-widest'>explore camel verse</p>
                </div> */}
            </div>
        </div>
    )
